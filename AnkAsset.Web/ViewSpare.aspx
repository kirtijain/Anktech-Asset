<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewSpare.aspx.cs" Inherits="AnkAsset.Web.ViewSpare" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <h3 class="section-title text-center">Asset Spare List</h3>
...
&nbsp;
      ...
      <asp:Button ID="Button1" runat="server" Text="Search" OnClick="ViewAssetSpare_Click" CssClass="btn btn-primary btn-submit"/>
...
<Columns>
 <asp:TemplateField HeaderText="Asset Type" ItemStyle-Width="70px">
  ...
  <asp:TemplateField HeaderText="Spare Part Name" ItemStyle-Width="140px">
       <ItemTemplate>
     ...
     <asp:TemplateField HeaderText="Spare Serial No" ItemStyle-Width="160px">
     <ItemTemplate>
    ...
    <EditItemTemplate>
      ...
      <asp:TemplateField HeaderText="Spare Model No" ItemStyle-Width="156px">
     <ItemTemplate>
...
<asp:TemplateField HeaderText="Spare Company" ItemStyle-Width="120px">
     <ItemTemplate>
   ...
   <asp:TemplateField HeaderText="Spare Part Price" ItemStyle-Width="130px">
     <ItemTemplate>
   ...
   <%-- <asp:TemplateField HeaderText="Description" ItemStyle-Width="150px">
    ...
    <asp:TemplateField HeaderText="Spare Purchase Date" ItemStyle-Width="180px">
     <ItemTemplate>
