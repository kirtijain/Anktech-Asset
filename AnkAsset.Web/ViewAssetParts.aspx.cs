...
{
    public partial class ViewAssetParts : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string modelno)
        {
            DataSet ds = new DataSet();
             ds = AssetPartInfoProvider.ViewAssetPartInfo(modelno);
        ...
        protected void ViewAssetPart_Click(object sender, EventArgs e)
        {
        ...
        protected void lkDelete_Click(object sender, EventArgs e)
        {
            ...
            AssetPartInfoProvider.DeleteAssetPartData(id);
            BindGrid(modelno);
        }
    }
}