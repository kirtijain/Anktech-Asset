<%@ Page Title="" Language="C#"  AutoEventWireup="true"MasterPageFile="~/Site.Master" CodeBehind="ViewAssetParts.aspx.cs" Inherits="AnkAsset.Web.ViewAssetParts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <h3 class="section-title text-center">Asset Parts List</h3>

      <a href="AssetPart.aspx" class="section-title text-center">Add Asset Parts</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
      ...
      <asp:Button ID="Button1" runat="server" Text="Search" OnClick="ViewAssetPart_Click" CssClass="btn btn-primary btn-submit"/>
...
<Columns>
 <asp:TemplateField HeaderText="Asset Type" ItemStyle-Width="100px">
    ...
    <asp:TemplateField HeaderText="Bill No" ItemStyle-Width="150px">
     <ItemTemplate>
    ...
    <asp:TemplateField HeaderText="Asset Name" ItemStyle-Width="150px">
     <ItemTemplate>
  ...
  <asp:TemplateField HeaderText="Part Name" ItemStyle-Width="140px">
    ...
    <EditItemTemplate>
      ...
      <asp:TemplateField HeaderText="Model No" ItemStyle-Width="140px">
     <ItemTemplate>
...
<asp:TemplateField HeaderText="Company" ItemStyle-Width="100px">
   ...
   <asp:TemplateField HeaderText="Part Price" ItemStyle-Width="140px">
     <ItemTemplate>
    ...
    <asp:TemplateField HeaderText="Purchase Date" ItemStyle-Width="150px">
     <ItemTemplate>
  ...
  <asp:TemplateField HeaderText="Warrenty Months" ItemStyle-Width="140px">
    ...
    <EditItemTemplate>
      ...
      <asp:TemplateField HeaderText="Is Occupied" ItemStyle-Width="120px">
     <ItemTemplate>
         <asp:Label ID="lblIsOccupied" runat="server" Text='<%#Eval("IsOccupied") %>'/>
     </ItemTemplate>
    <EditItemTemplate>
         <asp:TextBox ID="txtIsOccupied" width="30px"  runat="server" Text='<%#Eval("IsOccupied") %>'/>
     </EditItemTemplate>
 </asp:TemplateField>

      <asp:TemplateField HeaderText="Edit"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>             
              <a href='<%# "AssetPart.aspx?AssetPartId="+ Eval("AssetPartId")%>'>Edit</a>
            </ItemTemplate>
         ...
         <asp:TemplateField HeaderText="Delete"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                 <asp:LinkButton ID="lkDelete" runat="server" Text="Delete" CommandArgument = '<%# Eval("AssetPartId")%>'  OnClientClick="return confirm('Are you sure you want to delete selected record ?')" OnClick="lkDelete_Click" />
            </ItemTemplate>           
             <HeaderStyle HorizontalAlign="Center" />
             <ItemStyle HorizontalAlign="Center" />
             ...
             <%-- <FooterTemplate>
            <a href="AssetPart.aspx" style="color:#000" >Add New Row</a>
    </FooterTemplate>--%>
  </asp:TemplateField>   
 </Columns>
