...
{
    public partial class ViewFaulty : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string modelno)
        {
            ...
            ds = AssetPartInfoProvider.ViewAssetFaultyInfo(modelno);
        ...
        protected void ViewAssetFaulty_Click(object sender, EventArgs e)
        {
